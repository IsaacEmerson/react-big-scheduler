    ...
    _createClass(ResourceView, [{
        ...
        value: function render() {
            ...
            var resourceList = displayRenderData.map(function (item) {
                ...
                if (item.hasChildren) {
                    indent = item.expanded ? _react2.default.createElement(_icon2.default, { type: 'up', key: 'es' + item.indent, style: {}, className: '',
                        onClick: function onClick() {
                            if (!!toggleExpandFunc) toggleExpandFunc(schedulerData, item.slotId);
                        } }) : _react2.default.createElement(_icon2.default, { type: 'down', key: 'es' + item.indent, style: {}, className: '',
                        onClick: function onClick() {
                            if (!!toggleExpandFunc) toggleExpandFunc(schedulerData, item.slotId);
                        } });
                }
