            ...
            if (eventItemPopoverTemplateResolver != undefined) {
                ...
                if (viewEventText !== undefined && viewEventClick !== undefined && (eventItem.clickable1 == undefined || eventItem.clickable1)) {
                    var col = _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _Button2.default,
                            { className: 'btn-purple', type: 'primary', style: { cursor: 'pointer' }, onClick: function onClick() {
                    ...
                    if (viewEvent2Text !== undefined && viewEvent2Click !== undefined && (eventItem.clickable2 == undefined || eventItem.clickable2)) {
                        col = _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _Button2.default,
                                { className: 'btn-purple', variant: 'contained', color: 'primary', style: { cursor: 'pointer' }, onClick: function onClick() {
                                        viewEventClick(schedulerData, eventItem);
                                    } },
                                'Editar'
                            ),
                            _react2.default.createElement(
                                _Button2.default,
                                { style: { cursor: 'pointer', marginLeft: '8px' }, onClick: function onClick() {
                    ...
                    var _col = _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _Button2.default,
                            { style: { cursor: 'pointer', marginLeft: '16px' }, onClick: function onClick() {
                                    viewEvent2Click(schedulerData, eventItem);
                                } },
                            'Cancelar'
                        )
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _row2.default,
                        { type: 'flex', align: 'middle', style: { paddingTop: '12px' } },
                        _react2.default.createElement(
                            _col3.default,
                            { span: 2 },
                            _react2.default.createElement('div', null)
